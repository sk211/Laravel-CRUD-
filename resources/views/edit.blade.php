...
<form action="{{route('update', $student->id)}}" method="POST">
  @csrf
    ...
    <input type="text" class="form-control" name="frist_name" value="{{$student->frist_name}}" placeholder="Enter Frist name">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <input type="number" class="form-control" name="phone" value="{{$student->phone}}" placeholder="Enter Phone numbr">
    </div>
    <div class="form-group">
